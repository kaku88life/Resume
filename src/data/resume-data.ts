export const hero = {
  headline: "台灣棒球正處於最好的時代",
  subheadline:
    "我希望成為推動更多人愛上棒球的一份子——透過數據讓看球更有趣、讓入門門檻更低，讓下一代能持續投入棒球運動。",
  name: "郭子睿",
  position: "應徵野球革命 後端工程師（全遠端）",
  contact: {
...
export const about = {
  summary:
    "具備棒球深度知識與不動產業務實戰背景的 AI 賦能開發者。透過 Claude Code 進行 Vibe Coding，能從零獨立交付完整的 Web 應用。3 個月內交付 3 個生產級應用，涵蓋棒球數據平台、不動產 AI 顧問、多租戶 CRM 系統。",
  baseball: [
    "15 年棒球觀賽經驗，10 年 Fantasy Baseball（Keeper/Dynasty League）實戰",
    "高中棒球校隊 + 大學乙組棒球 1 年——不只看球，實際打過球",
    "富邦悍將 & 德州遊騎兵球迷",
    "熟悉進階數據：BA、Barrel%、WAR、RF/DRS、Zone%、K%、SwStr%、FIP、BABIP、wRC+",
    "理解 Statcast 數據（球速、轉速、擊球初速、擊球仰角）的應用場景",
  ],
  languages: [
    { name: "中文", level: "母語" },
    { name: "日文", level: "JLPT N1（流利，具備商務日文實戰經驗）", highlight: true },
    { name: "英文", level: "基礎溝通" },
  ],
  motivation: [
    "我是野球革命的目標用戶——15 年球迷、10 年 Fantasy 玩家、打過棒球，知道球迷想看什麼數據。",
    ...
    "誠實的期待——希望透過這份工作磨練後端技術，同時用棒球知識和產品直覺為野球革命創造價值。",
  ],
};
...
export const timeline = [
  ...
  },
  {
    ...
    role: "跨國不動產業務",
    description:
      "管理 4,132 筆客戶、促成 92 件日本不動產成交。每年舉辦約 100 場說明會，自行建立客戶數據分析體系。",
    highlights: [
      "4,132 筆跨六都客戶資料",
      "92 件成交（80 位客戶）",
      "每年 100+ 場說明會",
...
export const mainProjects = [
  {
    ...
    motivation:
      "我是這個 16 隊 Keeper League 的 Commissioner（聯盟掌）。每年休賽季都要花大量時間手動處理合約計算、薪資驗算等繁瑣作業。我決定把整個流程自動化，讓我能把時間花在真正有趣的部分：分析球員數據和制定戰略。",
    myWork: [
  ...
  },
  {
    ...
    motivation:
      "5 年不動產業務經驗讓我看到一個問題：台灣實價登錄的「每坪單價」往往包含灌水的公設面積，消費者無法準確判斷。大型業者不太願意花時間用「實坪制」重新計算。我想讓 450 萬+ 筆交易資料透明化，搭配視覺化圖表和 AI 分析，讓消費者看清市場真實面貌。",
    myWork: [
